...
public class GT_Worldgen_Stone_Ore_SingleBlock extends GT_Worldgen_Ore {
	...
	public GT_Worldgen_Stone_Ore_SingleBlock(String aName, boolean aDefault, Block aBlockID, int aBlockMeta, int aDimensionType, int aAmount, int aSize, int aProbability, int aMinY, int aMaxY, Collection<String> aBiomeList, boolean aAllowToGenerateinVoid, Block[] aOreIDs, int[] aOreMetas, int[] aOreChances) {
	...
	public boolean executeWorldgen(World aWorld, Random aRandom, String aBiome, int aDimensionType, int aChunkX, int aChunkZ, IChunkProvider aChunkGenerator, IChunkProvider aChunkProvider) {
		if (aDimensionType == mDimensionType && (mBiomeList.isEmpty() || mBiomeList.contains(aBiome)) && (mProbability <= 1 || aRandom.nextInt(mProbability) == 0)) {
			for (int i = 0; i < mAmount; i++) {
				...
				if (mAllowToGenerateinVoid || aWorld.getBlock(tX, tY, tZ) != Blocks.air) {
			                        ...
			                        if (var39 * var39 + var42 * var42 < 1.0D) {
			                            for (int var44 = var34; var44 <= var37; ++var44) {
			                                ...
			                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && ((
			                                				...
			                                				&&aWorld.getBlock(var38, var41, var44)==Blocks.air) 
			                                				|| (block != null
			                                				&& (block.isReplaceableOreGen(aWorld, var38, var41, var44,Blocks.stone) 
			                                				|| block.isReplaceableOreGen(aWorld, var38, var41, var44, Blocks.end_stone) 
			                                				|| block.isReplaceableOreGen(aWorld, var38, var41, var44, Blocks.netherrack))))) {
