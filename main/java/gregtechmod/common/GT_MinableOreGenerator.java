...
public class GT_MinableOreGenerator extends WorldGenerator
{
    ...
    private Block minableBlockId, mBlockID;
    ...
    public GT_MinableOreGenerator(Block block, int numberBlocks) {
        minableBlockId = block;
        numberOfBlocks = numberBlocks;
    }
    
    public GT_MinableOreGenerator(Block block, int meta, int number, boolean aAllowVoid, Block aBlockIDReplace) {
        this(block, number);
        minableBlockMeta = meta;
        allowVoid = aAllowVoid;
        mBlockID = aBlockIDReplace;
    }
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41) {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D) {
                            for (int var44 = var34; var44 <= var37; ++var44) {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && ((allowVoid&&par1World.getBlock(var38, var41, var44)==null) || (block != null && block.isReplaceableOreGen(par1World, var38, var41, var44, mBlockID)))) {
