...
public class GT_BlockMetaID_Stone1 extends Block {
    ...
    public float getBlockHardness(World par1World, int par2, int par3, int par4) {
        return blockHardness = blockHardness * 3.0F;
    }
    ...
    public void registerBlockIcons(IIconRegister par1IconRegister) {
    	for (int i = 0; i < mIcons.length; i++) 
    		mIcons[i] = par1IconRegister.registerIcon(GregTech_API.TEXTURE_PATH_BLOCK + (GregTech_API.sConfiguration.system?"troll":getUnlocalizedName() + "/" + i));
	}
